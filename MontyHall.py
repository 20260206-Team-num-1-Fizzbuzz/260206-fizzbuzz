...
print("Not switching allows you to win", end=" ")
print(sum(monty_hall(randrange(3), switch=False) for x in range(iterations)), end=" ")
print("out of", iterations, "times.")

print("Switching allows you to win", end=" ")
print(sum(monty_hall(randrange(3), switch=True) for x in range(iterations)), end=" ")
print("out of", iterations, "times.\n")
